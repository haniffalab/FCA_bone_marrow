...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/fig2d_neut_cds_20200717.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="neut_20200717"
progenitor = 'HSC'
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_fdg_20200717.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "neut_monocle3_pst_by_celltype_20200717.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "neut_monocle3_pst_by_pst_20200717.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_degs_20200717.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_degs_gene_modules_20200717.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_merged_deg_info_20200717.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_agg_mat_20200717.csv")
...
p
ggsave(file.path(figs.addr, "neut_monocle3_gene_modules_20200717.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_neut_20200717.pdf" 15x10

final_order = c("Module 31", "Module 28", "Module 35", "Module 21", "Module 4", "Module 15", 
                "Module 7", "Module 16", "Module 32", "Module 36", "Module 8", "Module 13", 
                "Module 18", "Module 19", "Module 23", "Module 25", "Module 27", "Module 26", 
                "Module 21", "Module 28",
                "Module 33", "Module 29",
                "Module 34", "Module 24", "Module 32", "Module 5", "Module 6", "Module 17",
                "Module 29", "Module 34", "Module 10", "Module 12", "Module 9", "Module 11", 
                "Module 30", "Module 14", "Module 20", "Module 22",  "Module 1", "Module 3",
                "Module 2")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_final_agg_mat_20200717.csv")
# now, save as "monocle3_heatmap_neut_20200717.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_monocle3_pst_metadata_20200717.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_cds_final_20200717.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_cds_final_20200717.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_agg_mat_20200717.csv", row.names="X")
agg_mat
