...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/fig2c_2d_myeloid_dc_cds_20200420.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="dc_20200420"
progenitor = 'HSC'
celltype.trajectory = c('HSC', 'MPP myeloid', 
                'MPP lymphoid', 'ELP', 'pDC progenitor', 'pDC', 'tDC', 'myeloid DC progenitor', 'DC precursor', 
                'DC1', 'DC2', 'DC3')
palette.colours = c('#d200d2', '#0000ff', '#0000ff', '#7b7bff', '#cbcbff', '#005300',
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_fdg_20200420.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "myeloid_dc_monocle3_pst_by_celltype_20200420.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "myeloid_dc_monocle3_pst_by_pst_20200420.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_degs_20200420.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_degs_gene_modules_20200420.csv")

#Maximal modularity is 0.908140759141988 for resolution parameter 0.01
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_merged_deg_info_20200420.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_agg_mat_20200420.csv")
...
p
ggsave(file.path(figs.addr, "myeloid_dc_monocle3_gene_modules_20200420.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_myeloid_dc_20200420.pdf" 15x10

final_order = c("Module 21", "Module 16", "Module 7", "Module 20", "Module 11", "Module 25", 
                 "Module 13", "Module 2", "Module 8", "Module 23", "Module 12",
                "Module 24", "Module 9", "Module 26", "Module 1",  
                "Module 17", "Module 4", "Module 18",  "Module 10",  "Module 19",   
                "Module 3", "Module 6", "Module 22", "Module 15", "Module 14",  "Module 5")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_final_agg_mat_20200420.csv")
# now, save as "monocle3_heatmap_myeloid_dc_20200420.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/myeloid_dc_monocle3_pst_metadata_20200420.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/myeloid_dc_cds_final_20200420.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/myeloid_dc_cds_final_20200420.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/myeloid_dc_monocle3_overall_agg_mat_20200420.csv", row.names="X")
agg_mat
final_order = c("Module 21", "Module 16", "Module 7", "Module 20", "Module 11", "Module 25", 
                 "Module 13", "Module 2", "Module 8", "Module 23", "Module 12",
                "Module 24", "Module 9", "Module 26", "Module 1",  
