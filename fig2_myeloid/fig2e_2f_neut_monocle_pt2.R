...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/fig2e_neut_cds_20200615.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="neut_20200615"
progenitor = 'HSC'
celltype.trajectory = c('HSC', 'MPP myeloid', 'CMP', 'GMP', 'neut myeloid', 
        'promyelocyte', 'myelocyte', 'neutrophil')
palette.colours = c('#d200d2', '#0000ff', '#a56900', '#f79d00', '#ffc055', '#ff254e',
       '#ff7790', '#ffc7d2')
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_fdg_20200615.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "neut_monocle3_pst_by_celltype_20200615.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "neut_monocle3_pst_by_pst_20200615.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_degs_20200615.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_degs_gene_modules_20200615.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_merged_deg_info_20200615.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_agg_mat_20200615.csv")
...
p
ggsave(file.path(figs.addr, "neut_monocle3_gene_modules_20200615.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_neut_20200615.pdf" 15x10

final_order = c("Module 36", "Module 40", "Module 10", "Module 38", "Module 35", "Module 37", 
                "Module 39", "Module 38", "Module 32", "Module 4", "Module 34", "Module 6",
                "Module 27", "Module 8", "Module 9", "Module 11", "Module 14", "Module 15",
                "Module 29", "Module 39", "Module 12", "Module 1", "Module 18", "Module 19", 
                "Module 35", "Module 13", "Module 30", "Module 3",  "Module 2", "Module 25",
                "Module 33", "Module 16", "Module 13", "Module 22", "Module 23", "Module 24",
                "Module 7", "Module 5",  "Module 17",  "Module 21", "Module 28", 
                "Module 31", "Module 20",  "Module 26")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_final_agg_mat_20200615.csv")
# now, save as "monocle3_heatmap_neut_20200615.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_monocle3_pst_metadata_20200615.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_cds_final_20200615.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/neut_cds_final_20200615.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/neut_monocle3_overall_agg_mat_20200615.csv", row.names="X")
agg_mat
