...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/fig2d_neut_cds_20210112.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/figs/neut_monocle/"
#fig_prefix="fbm_neut_monocle3_20210112"
progenitor = 'HSC'
celltype.trajectory = c('HSC', 'LMPP', 'MPP myeloid', 
                        'CMP', 'GMP', 'promyelocyte', 'myelocyte', 'neutrophil')
palette.colours = c('#d200d2', '#EF4352', '#0000ff', '#a56900', '#f79d00', '#ff254e',
       '#ff7790', '#ffc7d2')
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_fdg_20210112.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "neut_pst_by_celltype_20210112.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "neut_monocle3_pst_by_pst_20210112.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_degs_20210112.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_degs_gene_modules_20210112.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_merged_deg_info_20210112.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_agg_mat_20210112.csv")
...
p
ggsave(file.path(figs.addr, "neut_monocle3_gene_modules_20210112.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_neut_20210112.pdf" 15x10

final_order = c("Module 38", "Module 22", "Module 1", "Module 10", "Module 3", "Module 26",
                "Module 4", "Module 5", "Module 6", "Module 12", "Module 36",
                "Module 24", "Module 27",
                "Module 19", "Module 30", "Module 37", "Module 24", "Module 32", "Module 35", 
                "Module 3", "Module 29", "Module 14", "Module 2", "Module 7", "Module 33", 
                "Module 28", "Module 34",
                "Module 17", "Module 18",
                "Module 23", "Module 16", "Module 20", "Module 15", "Module 8", "Module 21",
                "Module 9", "Module 31", "Module 11", "Module 13", "Module 25")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_final_agg_mat_20210112.csv")
# now, save as "monocle3_heatmap_neut_20210112.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/neut_monocle3_pst_metadata_20210112.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/neut_cds_final_20210112.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/neut_cds_final_20210112.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/neut_monocle3_overall_agg_mat_20210112.csv", row.names="X")
agg_mat
