...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/fig5e_5f_downs_eryth_cds_20200625.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="downs_eryth_20200625"
progenitor = 'HSC'
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_fdg_20200625.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "downs_eryth_monocle3_pst_by_celltype_20200625.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "downs_eryth_monocle3_pst_by_pst_20200625_cellsize3.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_degs_20200625.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_degs_gene_modules_20200625.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_merged_deg_info_20200625.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_agg_mat_20200625.csv")
...
p
ggsave(file.path(figs.addr, "downs_eryth_monocle3_gene_modules_20200625.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_downs_eryth_20200625.pdf" 15x10

final_order = c("Module 4", "Module 1", 
                "Module 10", "Module 9", "Module 5", "Module 17", "Module 15", "Module 8", 'Module 13', 'Module 14', 'Module 16', 
                 "Module 7", "Module 3",  "Module 2",  "Module 12", "Module 6", 
                "Module 11")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_final_agg_mat_20200625.csv")
# now, save as "monocle3_heatmap_downs_eryth_20200625.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/downs_eryth_monocle3_pst_metadata_20200625.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/downs_eryth_cds_final_20200625.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/downs_eryth_cds_final_20200625.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/downs_eryth_monocle3_overall_agg_mat_20200625.csv", row.names="X")
agg_mat
celltype_order=c('HSC', 'MEMP', 'early.erythroid')
final_order = c("Module 4", "Module 1", 
                "Module 10", "Module 9", "Module 5", "Module 17", "Module 15", "Module 8", 'Module 13', 'Module 14', 'Module 16', 
