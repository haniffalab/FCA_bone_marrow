...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/fig3e_figs3e_fbm_bcell_cds_20210118.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/figs/"
fig_prefix="bcell_20210118"
progenitor = 'ELP'
celltype.trajectory = c('HSC', 'LMPP', 'ELP', 'pre pro B progenitor', 'pro B progenitor', 'pre B progenitor', 
                        'immature B cell', 'naive B cell')
palette.colours = c('#b63262', '#1B6633', '#F9F06C', '#F59771', '#C8D895', '#4C79BC', '#A9479A', '#F3C3DB')
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_fdg_20210118.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "bcell_monocle3_pst_by_celltype_20210118.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
get_earliest_principal_node <- function(cds, cell.labels2="HSC"){
  cell_ids <- which(colData(cds)[, "cell.labels"] == cell.labels2)
  closest_vertex <-
...
p
ggsave(file.path(figs.addr, "bcell_monocle3_pst_by_pst_20210118.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_degs_20210118.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_degs_gene_modules_20210118.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_merged_deg_info_20210118.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_agg_mat_20210118.csv")
...
p
ggsave(file.path(figs.addr, "bcell_monocle3_gene_modules_20210118.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_bcell_20210118.pdf" 15x10

final_order = c("Module 21", "Module 15", "Module 1", "Module 13", "Module 9", "Module 12", "Module 14", 
                "Module 17", "Module 16", "Module 2", "Module 10", "Module 20",  "Module 7",  "Module 11","Module 20", 
                "Module 8", "Module 3",  "Module 6",  "Module 18", "Module 4", "Module 19",  "Module 5")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_final_agg_mat_20210118.csv")
# now, save as "monocle3_heatmap_bcell_20210118.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/bcell_monocle3_pst_metadata_20210118.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/fbm_bcell_cds_final_20210118.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/fbm_bcell_cds_final_20210118.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/bcell_monocle3_overall_agg_mat_20210118.csv", row.names="X")
agg_mat
final_order = c("Module 21", "Module 15", "Module 1", "Module 13", "Module 9", "Module 12", "Module 14", 
                "Module 17", "Module 16", "Module 2", "Module 10", "Module 20",  "Module 7",  "Module 11","Module 20", 
                "Module 8", "Module 3",  "Module 6",  "Module 18", "Module 4", "Module 19",  "Module 5")
