...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/figs5d_downs_eryth_cds_20210125.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/figs/"
fig_prefix="downs_eryth_20210125"
progenitor = 'HSC'
celltype.trajectory = c('HSC', 'MEMP', 'early erythroid')
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_fdg_20210125.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "downs_eryth_monocle3_pst_by_celltype_20210125.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "downs_eryth_monocle3_pst_by_pst_20210125_cellsize3.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_degs_20210125.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_degs_gene_modules_20210125.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_merged_deg_info_20210125.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_agg_mat_20210125.csv")
...
p
ggsave(file.path(figs.addr, "downs_eryth_monocle3_gene_modules_20210125.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_downs_eryth_20210125.pdf" 15x10

final_order = c( "Module 9", "Module 19", 
                "Module 17", "Module 22", "Module 5", "Module 10", "Module 25", "Module 18", 'Module 23',
                "Module 2", "Module 11", "Module 20", "Module 15", "Module 24",
                'Module 16', 'Module 12', 
                 "Module 3", "Module 4",  "Module 6",  "Module 8", "Module 7", 
                "Module 14", "Module 1", "Module 26", "Module 13", "Module 21")

celltype_order=c('HSC', 'MEMP', 'early erythroid')
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_final_agg_mat_20210125.csv")
# now, save as "monocle3_heatmap_downs_eryth_20210125.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/downs_eryth_monocle3_pst_metadata_20210125.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/downs_eryth_cds_final_20210125.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/data/downs_eryth_cds_final_20210125.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/downs_eryth_monocle3_overall_agg_mat_20210125.csv", row.names="X")
agg_mat
celltype_order=c('HSC', 'MEMP', 'early.erythroid')
final_order = c( "Module 9", "Module 19", 
                "Module 17", "Module 22", "Module 5", "Module 10", "Module 25", "Module 18", 'Module 23',
...
#write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk2/resources_for_pipelines/gene_module_df_neg_pre_b_20200327.csv")
# plot the module expression
