...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/figs3e_ABM_bcell_cds_20200717.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="abm_bcell_20200717"
progenitor = 'ELP'
celltype.trajectory = c('HSC', 'LMPP', 'pro B progenitor', 'pre B cell', 'immature B cell', 'naive B cell')
palette.colours = c('#b63262', '#1B6633', '#C8D895', '#4C79BC', '#A9479A', '#F3C3DB')
...
umap_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_umap_20200717.csv", row.names = 1)
cds@int_colData@listData[["reducedDims"]][["UMAP"]] <- umap_coordinates
...
cds <- cluster_cells(cds, reduction_method = "UMAP", verbose=TRUE, resolution = 1e-03)
...
ggsave(file.path(figs.addr, "abm_bcell_monocle3_pst_by_celltype_20200717.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "abm_bcell_monocle3_pst_by_pst_20200717.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_degs_20200717.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_degs_gene_modules_20200717.csv")

#  Maximal modularity is 0.875472217075212 for resolution parameter 0.01
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_merged_deg_info_20200717.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_agg_mat_20200717.csv")
...
p
ggsave(file.path(figs.addr, "abm_bcell_monocle3_gene_modules_20200717.pdf"), width=10, height=10)
p
#dev.off()
...
# now, save as "monocle3_heatmap_abm_bcell_20200717.pdf" 15x10

final_order = c("Module 25", "Module 12", "Module 20",  "Module 4", "Module 7", "Module 15", "Module 21", 
                "Module 7", "Module 21", "Module 6", "Module 14", "Module 17", "Module 18", "Module 19", 
                "Module 2", "Module 23",
                "Module 24", "Module 3", "Module 9", "Module 22", "Module 10", "Module 1", "Module 11", "Module 8", 
                "Module 15", "Module 5", "Module 13", "Module 4", "Module 16")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_final_agg_mat_20200717.csv")
# now, save as "monocle3_heatmap_abm_bcell_20200717.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/abm_bcell_monocle3_pst_metadata_20200717.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/abm_bcell_cds_final_20200717.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/abm_bcell_cds_final_20200717.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/abm_bcell_monocle3_overall_agg_mat_20200717.csv", row.names="X")
agg_mat
# now, save as "monocle3_heatmap_abm_bcell_20200717.pdf" 15x10
final_order = c("Module 25", "Module 12", "Module 20",  "Module 4", "Module 7", "Module 15", "Module 21", 
                "Module 6", "Module 14", "Module 17", "Module 18", "Module 19", 
                "Module 2", "Module 23",
                "Module 24", "Module 3", "Module 9", "Module 22", "Module 10", "Module 1", "Module 11", "Module 8", 
                "Module 5", "Module 13", "Module 16")
...
#cell_group_df <- tibble::tibble(cell=row.names(colData(cds)), cell_group=colData(cds)$cell.labels2)
#agg_mat <- aggregate_gene_expression(cds, gene_module_df, cell_group_df)
#row.names(agg_mat) <- stringr::str_c("Module ", row.names(agg_mat))
