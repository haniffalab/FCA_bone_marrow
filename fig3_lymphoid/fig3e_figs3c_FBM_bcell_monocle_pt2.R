...
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/fig3e_figs3e_bcell_cds_20200715.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/figs/"
fig_prefix="bcell_20200715"
progenitor = 'ELP'
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_fdg_20200715.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "bcell_monocle3_pst_by_celltype_20200715.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "bcell_monocle3_pst_by_pst_20200715.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_degs_20200715.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_degs_gene_modules_20200715.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_merged_deg_info_20200715.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_agg_mat_20200715.csv")
...
p
ggsave(file.path(figs.addr, "bcell_monocle3_gene_modules_20200715.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_bcell_20200715.pdf" 15x10

final_order = c("Module 7", "Module 4", "Module 10", "Module 22", "Module 14", "Module 20", "Module 16", 
                "Module 2", 
                "Module 21", "Module 3", "Module 11", "Module 19", "Module 5",  "Module 6","Module 9", 
                "Module 13", "Module 15",  "Module 1",  "Module 8", "Module 18", "Module 12",  "Module 17")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_final_agg_mat_20200715.csv")
# now, save as "monocle3_heatmap_bcell_20200715.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/bcell_monocle3_pst_metadata_20200715.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/bcell_cds_final_20200715.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/data/bcell_cds_final_20200715.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs/resources_for_pipelines/bcell_monocle3_overall_agg_mat_20200715.csv", row.names="X")
agg_mat
final_order = c("Module 7", "Module 4", "Module 10", "Module 22", "Module 14", "Module 20", "Module 16", 
                "Module 2", 
                "Module 21", "Module 3", "Module 11", "Module 19", "Module 5",  "Module 6","Module 9", 
