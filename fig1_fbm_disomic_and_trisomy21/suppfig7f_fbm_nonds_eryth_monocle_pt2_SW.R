...
# Download the erythroid FBM data as a CDS object from the monocle 2 obj (is raw and has HVGs imported from scanpy)
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/data/figs8e_fbm_eryth_cds_20210429.RDS")
ie_regions_cds

# set variables
figs.addr = "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/figs/"
fig_prefix="fbm_eryth_20210429"
progenitor = 'HSC'
...
fdg_coordinates <- read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_fdg_20210429.csv", row.names = 1)
...
ggsave(file.path(figs.addr, "fbm_eryth_monocle3_pst_by_celltype_20210429.pdf"), width=12, height=10)
p + scale_colour_manual(values=palette.colours) 
...
p
ggsave(file.path(figs.addr, "fbm_eryth_monocle3_pst_by_pst_20210429_cellsize3.pdf"), width=12, height=10)
p
...
pr_deg_ids
write.csv(pr_deg_ids, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_degs_20210429.csv")
...
write.csv(gene_module_df, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_degs_gene_modules_20210429.csv")
...
head(merged)
write.csv(merged, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_merged_deg_info_20210429.csv")
...
agg_mat
as.matrix(agg_mat)
write.csv(as.matrix(agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_agg_mat_20210429.csv")
...
p
ggsave(file.path(figs.addr, "fbm_eryth_monocle3_gene_modules_20210429.pdf"), width=10, height=10)
p
dev.off()
...
# now, save as "monocle3_heatmap_fbm_eryth_20210429.pdf" 15x10

final_order = c("Module 20", 
                "Module 23", "Module 15",  
                 "Module 17", "Module 1", "Module 14",  
                 "Module 11", "Module 5", "Module 10", 
                "Module 18", "Module 3", "Module 7", "Module 9",
                "Module 22", "Module 12", "Module 6",  
                "Module 19", "Module 16", "Module 8", "Module 21", 
                "Module 4", "Module 13", 
                "Module 2")
...
write.csv(as.matrix(final_agg_mat), "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_final_agg_mat_20210429.csv")
# now, save as "monocle3_heatmap_fbm_eryth_20210429.pdf" 15x10
...
write.csv(point.data["cell_color"], "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/data/fbm_eryth_monocle3_pst_metadata_20210429.csv")
# save cds
saveRDS(cds, "/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/data/fbm_eryth_cds_final_20210429.RDS")

# ----------------------------------------------------------------------------------------------------------------------------------------------

# RELOAD THE HEATMAP REAL QUICK AND REPLOT.....
ie_regions_cds <- readRDS("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/data/fbm_eryth_cds_final_20210429.RDS")
ie_regions_cds
agg_mat=read.csv("/Users/b8058304/Documents/PhD_work/Coding/manuscript_figs_mk3/resources_for_pipelines/fbm_eryth_monocle3_overall_agg_mat_20210429.csv", row.names="X")
agg_mat
celltype_order=c('HSC', 'MEP_MEMP', 'early.erythroid')
final_order = c("Module 20", 
                "Module 23", "Module 15",  
