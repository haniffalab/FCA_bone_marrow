...
Metadata for datasets described above are provided in manuscript Supplementary Tables. All source data are available in the accompanying source data file, unless manuscript or figure legend refers to a Supplementary Table. 
